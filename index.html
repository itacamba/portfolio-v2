...
<body>
    ...
    <div id="main">
        <header class="container-80">
            ...
            <nav class="navbar">
                ...
                <a href="./resumecarla.pdf" class="theme-btn" target="_blank" download >Resume</a>
    ...
    <section  id="about" class="container-80">
        ...
        <div class="about-me">
            ...
            <a href="./resumecarla.pdf" target="_blank" class="theme-btn" download >Resume</a>
        </div>
    </section>
    <section id="projects" class="container-80">
        ...
        <div id="projects-container">
            <div class="project">
                ...
                <div class="project-content">
                    ...
                    <h2>A single page application built for a cyber security start up.  Allows the
                        user to see all the services offereed and to send a request for more 
